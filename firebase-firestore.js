        ...
        : (function (t) {
            ...
            for (; n < t.length; ) {
              ...
              if (r < 128) e[s++] = String.fromCharCode(r);
                ...
                const i = t[n++];
                e[s++] = String.fromCharCode(((31 & r) << 6) | (63 & i));
              } else if (r > 239 && r < 365) {
                const i =
                  (((7 & r) << 18) |
                    ((63 & t[n++]) << 12) |
...
const c = () =>
  ...
  d = (t) => {
    const e = ((t) => {
      var e, n;
      return null ===
        (n = null === (e = l()) || void 0 === e ? void 0 : e.emulatorHosts) ||
        void 0 === n
        ? void 0
        : n[t];
    })(t);
...
function m() {
  return (
    !(function () {
      var t;
      const e =
        null === (t = l()) || void 0 === t ? void 0 : t.forceEnvironment;
      if ("node" === e) return !0;
...
(U.prototype.s = !1),
  (U.prototype.na = function () {
    ...
    !this.s &&
      ((this.s = !0), this.M(), 0) &&
      ((t = this),
      (Object.prototype.hasOwnProperty.call(t, M) && t[M]) || (t[M] = ++F));
  }),
...
function _t(t, e) {
  ...
  for (let e = 1; e < arguments.length; e++) {
    ...
    for (let e = 0; e < St.length; e++)
      (n = St[e]), Object.prototype.hasOwnProperty.call(s, n) && (t[n] = s[n]);
  }
}
function xt(t) {
...
function kt(t, e, n, s, r) {
  ...
  return (
    (n = Bt(n)),
    t && t[wt] ? t.N(e, n, L(s) ? !!s.capture : !!s, r) : Rt(t, e, n, !1, s, r)
  );
}
...
function Lt(t, e, n, s, r) {
  ...
  return (
    (n = Bt(n)),
    t && t[wt] ? t.O(e, n, L(s) ? !!s.capture : !!s, r) : Rt(t, e, n, !0, s, r)
  );
}
function Mt(t, e, n, s, r) {
  if (Array.isArray(e)) for (var i = 0; i < e.length; i++) Mt(t, e[i], n, s, r);
  else
    (s = L(s) ? !!s.capture : !!s),
      (n = Bt(n)),
      t && t[wt]
        ...
        for (r = n.Fa.g.parse(e), e = 0; e < r.length; e++) {
          ...
          if (((n.T = c[0]), (c = c[1]), 2 == n.G))
            if ("c" == c[0]) {
              ...
              var o = t;
              if ((((s = n).sa = ds(s, s.H ? s.ka : null, s.V)), o.J)) {
                En(s.h, o);
                var a = o,
                  u = s.J;
                u && a.setTimeout(u), a.B && (Ge(a), Be(a)), (s.g = o);
              } else ss(s);
              0 < n.i.length && Zn(n);
          ...
          if (
            ...
            if (
              ...
              if (this.Z && !this.J) {
                ...
                if (!(n = c)) {
                  (this.i = !1), (this.o = 3), ye(12), je(this), Ke(this);
                  break t;
                }
                he(
                  this.j,
              ...
              this.P
                ? (Pe(this, h, o),
                  rt &&
                    this.i &&
                    3 == h &&
                    (ae(this.S, this.T, "tick", this.hb), this.T.start()))
                : (he(this.j, this.m, o, null), $e(this, o)),
                4 == h && je(this),
                this.i &&
                  !this.I &&
                  (4 == h ? us(this.l, this) : ((this.i = !1), Be(this)));
            } else
...
function mn(t, e, n) {
  dn(t, e),
    0 < n.length && ((t.i = null), t.g.set(gn(t, e), K(n)), (t.h += n.length));
}
function gn(t, e) {
...
function pn(t) {
  (this.l = t || yn),
    N.PerformanceNavigationTiming
      ? (t =
          0 < (t = N.performance.getEntriesByType("navigation")).length &&
  ...
  t: {
    ...
    for (;;) {
      ...
      for (let o = 0; o < n; o++) {
        let n = r[o].h;
        const a = r[o].g;
        if (((n -= e), 0 > n)) (e = Math.max(0, r[o].h - 100)), (i = !1);
        else
          try {
            xn(a, t, "req" + n + "_");
          } catch (t) {
...
function os(t) {
  ...
  var n = t.g;
  (t = t.ka), (n.K = 1), (n.v = tn(We(e))), (n.s = null), (n.P = !0), Oe(n, t);
}
function as(t) {
            ...
            return !(
              ...
              (t.m
                ...
                : 1 == t.G ||
                  2 == t.G ||
                  t.C >= (t.Za ? 0 : t.$a) ||
                  ((t.m = ve(P(t.Ja, t, e), cs(t, t.C))), t.C++, 0))
            );
          })(t, e)) ||
        (2 == s && rs(t))
      )
      ...
      (function (t, e) {
        ...
        if (N.Image) {
          ...
          (s.onload = q(Dn, n, s, "TestLoadImage: loaded", !0, e)),
            (s.onerror = q(Dn, n, s, "TestLoadImage: error", !1, e)),
            (s.onabort = q(Dn, n, s, "TestLoadImage: abort", !1, e)),
            (s.ontimeout = q(Dn, n, s, "TestLoadImage: timeout", !1, e)),
...
function ls(t) {
  if (((t.G = 0), (t.la = []), t.l)) {
    ...
    (0 == e.length && 0 == t.i.length) ||
      (j(t.la, e), j(t.la, t.i), (t.h.i.length = 0), K(t.i), (t.i.length = 0)),
      t.l.ua();
  }
}
function ds(t, e, n) {
...
((D = Fn.prototype).Ka = function (t) {
  ...
  (D.da = function (t, e, n, s) {
    ...
    (s = Array.from(n.keys()).find((t) => "content-type" == t.toLowerCase())),
      ...
      Kn(this),
        0 < this.B &&
          ((this.K = (function (t) {
            ...
            ? ((this.g.timeout = this.B), (this.g.ontimeout = P(this.qa, this)))
    ...
    if (this.m)
      if (((this.m = null), 1 == this.G)) {
        if (!t) {
          ...
          let i = this.s;
          if (
            (this.S && (i ? ((i = Tt(i)), _t(i, this.S)) : (i = this.S)),
          ...
          (e = ns(this, r, e)),
            ...
            i &&
              (this.N
                ? (e = "headers=" + encodeURIComponent(String(Qn(i))) + "&" + e)
        ...
        3 == this.G &&
          (t ? ts(this, t) : 0 == this.i.length || wn(this.h) || ts(this));
  }),
  (D.Ia = function () {
    if (
      ((this.u = null),
    ...
    this.t.onInit((t) => o(t)),
      setTimeout(() => {
        if (!this.auth) {
          ...
          t
            ? o(t)
            : (Ms("FirebaseAuthCredentialsProvider", "Auth not yet detected"),
              r.resolve(),
              (r = new js()));
        }
      }, 0),
    ...
    this.T.onInit((t) => s(t)),
      setTimeout(() => {
        if (!this.appCheck) {
          ...
          t
            ? s(t)
            : Ms("FirebaseAppCheckTokenProvider", "AppCheck not yet detected");
        }
      }, 0);
  }
  getToken() {
...
class ir {
  constructor(t, e) {
    ...
    if (t < -62135596800)
      throw new Ks(Gs.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    if (t >= 253402300800)
      throw new Ks(Gs.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
  }
  static now() {
...
class Ar {
  ...
  static N() {
    ...
    return (
      ...
      "YES" === (null === (t = process.env) || void 0 === t ? void 0 : t.O)
    );
  }
  static M(t, e) {
    return t.store(e);
...
class Rr {
  ...
  add(t) {
    return Ms("SimpleDb", "ADD", this.store.name, t, t), Lr(this.store.add(t));
  }
  get(t) {
  ...
  delete(t) {
    return (
      Ms("SimpleDb", "DELETE", this.store.name, t), Lr(this.store.delete(t))
    );
  }
  count() {
    ...
    return new xr((s, r) => {
      (t.onerror = (t) => {
        ...
        (t.onsuccess = (t) => {
          ...
          i.isDone ? s() : null === i.G ? r.continue() : r.continue(i.G);
        });
    }).next(() => xr.waitFor(n));
  }
  options(t, e) {
    ...
    Ms("IndexBackiller", `Scheduled in ${t}ms`),
      (this.task = this.asyncQueue.enqueueAfterDelay(
        ...
        async () => {
          this.task = null;
          try {
            Ms("IndexBackiller", `Documents written: ${await this.et.st()}`);
          } catch (t) {
            kr(t)
              ? Ms(
                  "IndexBackiller",
...
class Vr {
        ...
        () =>
          this.localStore.indexManager
            ...
            .next((e) => {
              if (null !== e && !n.has(e))
                return (
                  Ms("IndexBackiller", `Processing collection: ${e}`),
        ...
        this.localStore.localDocuments
          ...
          .next((n) => {
            ...
            return this.localStore.indexManager
              ...
              .next(
                (n) => (
                  Ms("IndexBackiller", `Updating offset: ${n}`),
                  this.localStore.indexManager.updateCollectionGroup(t, e, n)
                )
              )
              .next(() => r.size);
          })
  ...
  ot(t, e) {
    ...
    return (
      ...
      new br(n.readTime, n.documentKey, Math.max(e.batchId, t.largestBatchId))
    );
  }
}
class Pr {
...
function ii(t, e) {
  ...
  switch (n) {
    ...
    case 8:
      return (function (t, e) {
        return (
          Xr(t.geoPointValue.latitude) === Xr(e.geoPointValue.latitude) &&
          Xr(t.geoPointValue.longitude) === Xr(e.geoPointValue.longitude)
        );
      })(t, e);
    case 2:
      return (function (t, e) {
    ...
    case 10:
      return (function (t, e) {
        ...
        for (const t in n)
          if (n.hasOwnProperty(t) && (void 0 === s[t] || !ii(n[t], s[t])))
            return !1;
        return !0;
      })(t, e);
    default:
...
function hi(t) {
  return "nullValue" in t
    ...
    ? (function (t) {
        let e = "[",
          n = !0;
        for (const s of t.values || []) n ? (n = !1) : (e += ","), (e += hi(s));
        return e + "]";
      })(t.arrayValue)
    : "mapValue" in t
    ? (function (t) {
...
function yi(t) {
  ...
  if (t.mapValue) {
    ...
    return Gr(t.mapValue.fields, (t, n) => (e.mapValue.fields[t] = yi(n))), e;
  }
  if (t.arrayValue) {
...
function Oi(t) {
  return t instanceof Di
    ...
    : t instanceof Ai
    ? (function (t) {
        return t.op.toString() + " {" + t.getFilters().map(Oi).join(" ,") + "}";
      })(t)
    : "Filter";
}
class Vi extends Di {
  ...
  field(t) {
    if (t.isEmpty()) return this.value;
    {
      ...
      for (let n = 0; n < t.length - 1; ++n)
        if (((e = (e.mapValue.fields || {})[t.get(n)]), !pi(e))) return null;
  ...
  getFieldsMap(t) {
    ...
    for (let n = 0; n < t.length; ++n) {
      ...
      (pi(s) && s.mapValue.fields) ||
        ((s = { mapValue: { fields: {} } }), (e.mapValue.fields[t.get(n)] = s)),
        (e = s);
    }
  ...
  if (null !== n)
    for (let i = 0; i < t.orderBy.length; ++i)
      if (t.orderBy[i].field.isEqual(e)) {
        ...
        bi({ value: s, inclusive: r }, { value: t, inclusive: n.inclusive }) <
          0 && ((s = t), (r = n.inclusive));
        break;
      }
...
function ho(t, e, n) {
  ...
  if (null !== n)
    for (let i = 0; i < t.orderBy.length; ++i)
      if (t.orderBy[i].field.isEqual(e)) {
        const t = n.position[i];
        Ei({ value: s, inclusive: r }, { value: t, inclusive: n.inclusive }) >
          0 && ((s = t), (r = n.inclusive));
        break;
      }
  return { value: s, inclusive: r };
...
function Io(t) {
  ...
  if (!e._t)
    if ("F" === e.limitType)
      ...
      const n = e.endAt ? new Ti(e.endAt.position, e.endAt.inclusive) : null,
        s = e.startAt ? new Ti(e.startAt.position, e.startAt.inclusive) : null;
  ...
  return t instanceof ea
    ...
    : (function (t, e, n) {
        return Ho(t.precondition, e)
          ? (e.convertToNoDocument(e.version).setHasLocalMutations(), null)
          : n;
      })(t, e, n);
}
function Zo(t, e) {
          ...
          sr(t, e, (t, e) =>
            (function (t, e) {
              return (
                t.field.isEqual(e.field) &&
                (function (t, e) {
                  return (t instanceof Po && e instanceof Po) ||
...
class La {
  ...
  zt(t) {
    ...
    return e || Ms("WatchChangeAggregator", "Detected inactive target", t), e;
  }
  Yt(t) {
    ...
    e.fieldTransforms.length > 0 &&
      (n.updateTransforms = e.fieldTransforms.map((t) =>
        (function (t, e) {
          ...
          if (n instanceof Go)
            return { fieldPath: e.field.canonicalString(), increment: n.gt };
          throw Ps();
        })(0, t)
      )),
      ...
      ? e.updateTransforms.map((e) =>
          (function (t, e) {
            ...
            if ("setToServerValue" in e)
              qs("REQUEST_TIME" === e.setToServerValue), (n = new Vo());
              ...
              n = new Bo(t);
            } else "increment" in e ? (n = new Go(t, e.increment)) : Ps();
...
function lu(t) {
  return t instanceof Di
    ? (function (t) {
        if ("==" === t.op) {
          if (gi(t.value))
            return { unaryFilter: { field: cu(t.field), op: "IS_NAN" } };
          if (mi(t.value))
            return { unaryFilter: { field: cu(t.field), op: "IS_NULL" } };
        } else if ("!=" === t.op) {
          if (gi(t.value))
            return { unaryFilter: { field: cu(t.field), op: "IS_NOT_NAN" } };
          if (mi(t.value))
            return { unaryFilter: { field: cu(t.field), op: "IS_NOT_NULL" } };
        }
        return {
          fieldFilter: { field: cu(t.field), op: au(t.op), value: t.value },
        };
      })(t)
    : t instanceof Ai
    ? (function (t) {
  ...
  for (let i = 0; i < e; ) {
    ...
    switch (((e < 0 || e > n) && Ps(), t.charAt(e + 1))) {
      case "":
        ...
        let o;
        0 === r.length ? (o = n) : ((r += n), (o = r), (r = "")), s.push(o);
        break;
      case "":
...
class uc {
  ...
  getOverlaysForCollectionGroup(t, e, n, s) {
    ...
    return cc(t)
      .Z({ index: "collectionGroupOverlayIndex", range: o }, (t, e, n) => {
...
class hc {
  ...
  ce(t, e) {
    if ("nullValue" in t) this.he(e, 5);
      ...
      const n = Xr(t.doubleValue);
      isNaN(n) ? this.he(e, 13) : (this.he(e, 15), $r(n) ? e.le(0) : e.le(n));
...
class Ic {
  ...
  He(t, e) {
    return (
      ...
      ((0 === e.kind && "asc" === t.dir) || (1 === e.kind && "desc" === t.dir))
    );
  }
}
function bc(t) {
  ...
  return (
    ...
    (n =
      t instanceof Di
        ...
        : (function (t, e) {
            if (
              (qs(t.filters.length > 0 && e.filters.length > 0), Ci(t) && Ci(e))
            )
...
function Cc(t) {
  ...
  return (
    n.forEach((e) => {
      e instanceof Di
        ? s.push(e)
        : e instanceof Ai && (e.op === t.op ? s.push(...e.filters) : s.push(e));
    }),
...
class Lc {
  ...
  addFieldIndex(t, e) {
    ...
    if (e.indexState) {
      ...
      return r.next((t) => {
        n.put(
          rc(t, this.user, e.indexState.sequenceNumber, e.indexState.offset)
        );
      });
    }
    return r.next();
  ...
  deleteFieldIndex(t, e) {
    ...
    return n
      .delete(e.indexId)
      .next(() =>
        s.delete(IDBKeyRange.bound([e.indexId], [e.indexId + 1], !1, !0))
      )
      .next(() =>
        r.delete(IDBKeyRange.bound([e.indexId], [e.indexId + 1], !1, !0))
      );
  }
  getDocumentsMatchingTarget(t, e) {
    const n = Fc(t);
          ...
          return xr
            .forEach(r, (r, i) => {
              ...
              const a = (function (t, e) {
                ...
                d = this.en(r, i, h),
                f = this.nn(r, i, u),
                m = this.sn(r.indexId, a, l, c.inclusive, d, h.inclusive, f);
              return xr.forEach(m, (r) =>
                n.J(r, e.limit).next((e) => {
                  e.forEach((e) => {
                    const n = lr.fromSegments(e.documentKey);
            ...
            e.push(
              (function (t, e) {
                const n = e
                    ...
                    : wr.empty(),
                  s = t.fields.map(
                    ([t, e]) => new pr(hr.fromServerFormat(t), e)
                  );
                return new dr(t.indexId, t.collectionGroup, s, n);
              })(t, n)
            );
          })
        )
    ...
    return this.getFieldIndexes(t).next((t) =>
      0 === t.length
        ...
        : (t.sort((t, e) => {
            ...
            return 0 !== n ? n : nr(t.collectionGroup, e.collectionGroup);
          }),
          t[0].collectionGroup)
    );
  }
        ...
        (r) => (
          ...
          xr.forEach(r, (n) =>
            this._n(t, e, n).next((e) => {
              const r = this.wn(s, n);
              return e.isEqual(r) ? xr.resolve() : this.mn(t, s, n, e, r);
            })
          )
        )
      );
  ...
  _n(t, e, n) {
    ...
    return s
      .Z(
        ...
        (t, s) => {
          r = r.add(new yc(n.indexId, e, s.arrayValue, s.directionalValue));
        }
      )
      .next(() => r);
  }
...
class Kc {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    return i.add({}).next((o) => {
      ...
      const a = new Ku(o, e, n, s),
        ...
        c = [];
      let h = new Yi((t, e) => nr(t.canonicalString(), e.canonicalString()));
      for (const t of s) {
  ...
  lookupMutationBatch(t, e) {
    return $c(t)
      .get(e)
      .next((t) => (t ? (qs(t.userId === this.userId), Ju(this.yt, t)) : null));
  }
  Tn(t, e) {
    return this.In[e]
  ...
  getNextMutationBatchAfterBatchId(t, e) {
    ...
    return $c(t)
      .Z({ index: "userMutationsIndex", range: s }, (t, e, s) => {
        e.userId === this.userId && (qs(e.batchId >= n), (r = Ju(this.yt, e))),
          s.done();
      })
      .next(() => r);
  }
  getHighestUnacknowledgedBatchId(t) {
    ...
    let n = -1;
    return $c(t)
      .Z({ index: "userMutationsIndex", range: e, reverse: !0 }, (t, e, s) => {
        (n = e.batchId), s.done();
      })
      .next(() => n);
  }
      ...
      .Z({ range: s }, (n, s, i) => {
        ...
        if (o === this.userId && e.path.isEqual(c))
          return $c(t)
            ...
            .next((t) => {
              if (!t) throw Ps();
              qs(t.userId === this.userId), r.push(Ju(this.yt, t));
            });
        i.done();
      })
      .next(() => r);
      ...
      e.forEach((e) => {
        const r = vu(this.userId, e.path),
          ...
          o = Qc(t).Z({ range: i }, (t, s, r) => {
            const [i, o, a] = t,
              u = yu(o);
            i === this.userId && e.path.isEqual(u) ? (n = n.add(a)) : r.done();
          });
        s.push(o);
      }),
      ...
      e.forEach((e) => {
        s.push(
          $c(t)
            ...
            .next((t) => {
              if (null === t) throw Ps();
              qs(t.userId === this.userId), n.push(Ju(this.yt, t));
            })
        );
      }),
      xr.waitFor(s).next(() => n)
...
class Wc {
  ...
  removeTargetData(t, e) {
    return this.removeMatchingKeysForTargetId(t, e.targetId)
      ...
      .next(() => this.Vn(t))
      .next(
        (e) => (qs(e.targetCount > 0), (e.targetCount -= 1), this.Sn(t, e))
      );
  }
  removeTargets(t, e, n) {
    let s = 0;
  ...
  containsKey(t, e) {
    ...
    let r = 0;
    return Jc(t)
      .Z({ index: "documentTargetsIndex", X: !0, range: s }, ([t, e], n, s) => {
        0 !== t && (r++, s.done());
      })
      .next(() => r > 0);
  }
...
class nh {
  ...
  collect(t, e) {
    return -1 === this.params.cacheSizeCollectionThreshold
      ? (Ms("LruGarbageCollector", "Garbage collection skipped; disabled"),
        xr.resolve(qc))
  ...
  qn(t, e) {
    ...
    return this.calculateTargetCount(t, this.params.percentileToCollect)
      ...
      .next(
        (e) => ((r = e), (a = Date.now()), this.removeOrphanedDocuments(t, n))
      )
      .next(
        (t) => (
          (u = Date.now()),
...
class sh {
  ...
  Gn(t, e) {
    return (function (t, e) {
      let n = !1;
      return zc(t)
        .tt((s) => jc(t, s, e).next((t) => (t && (n = !0), xr.resolve(!t))))
        .next(() => n);
    })(t, e);
  }
  removeOrphanedDocuments(t, e) {
          ...
          if (!e)
            return (
              ...
              n
                ...
                .next(
                  () => (
                    n.removeEntry(i, or.min()), Jc(t).delete([0, mu(i.path)])
                  )
                )
            );
        });
...
class oh {
  ...
  zn(t, e, n) {
    ...
    return hh(t)
      .Z({ index: "documentKeyIndex", range: r }, (t, e, s) => {
        ...
        o && o.isEqual(r) && (n(o, e), (o = i.hasNext() ? i.getNext() : null)),
          o ? s.j(lh(o)) : s.done();
      })
      .next(() => {
  ...
  getAllFromCollectionGroup(t, e, n, s) {
    ...
    return hh(t)
      .Z(
        { index: "collectionGroupIndex", range: IDBKeyRange.bound(i, o, !0) },
        (t, e, n) => {
          const i = this.jn(
            lr.fromSegments(
  ...
  jn(t, e) {
    if (e) {
      const t = (function (t, e) {
        let n;
        if (e.document) n = Za(t.ie, e.document, !!e.hasCommittedMutations);
  ...
  applyChanges(t) {
    ...
    return (
      this.changes.forEach((r, i) => {
        ...
        if (
          (e.push(this.Yn.removeEntry(t, r, o.readTime)), i.isValidDocument())
        ) {
...
class gh {
  ...
  getDocument(t, e) {
    ...
    return this.documentOverlayCache
      ...
      .next((t) => (null !== n && Jo(n.mutation, t, Zi.empty(), ir.now()), t));
  }
  getDocuments(t, e) {
    return this.remoteDocumentCache
      .getEntries(t, e)
      .next((e) => this.getLocalViewOfDocuments(t, e, Sa()).next(() => e));
  }
      ...
      this.recalculateAndSaveOverlays(t, r).next(
        (t) => (
          ...
          e.forEach((t, e) => {
            ...
            return o.set(
              t,
              new mh(e, null !== (n = i.get(t)) && void 0 !== n ? n : null)
            );
          }),
          o
        )
  ...
  getDocumentsMatchingCollectionQuery(t, e, n) {
    ...
    return this.documentOverlayCache
      ...
      .next(
        (r) => (
          (s = r),
          this.remoteDocumentCache.getDocumentsMatchingQuery(t, e, n, s)
        )
      )
      .next((t) => {
        s.forEach((e, n) => {
          const s = n.getKey();
          null === t.get(s) && (t = t.insert(s, no.newInvalidDocument(s)));
        });
        let n = ya();
        return (
          t.forEach((t, r) => {
...
class yh {
  ...
  getOverlaysForCollectionGroup(t, e, n, s) {
    ...
    for (
      ;
      a.hasNext() &&
      (a.getNext().value.forEach((t, e) => o.set(t, e)), !(o.size() >= s));
...
class bh {
  ...
  addEntry(t, e) {
    const n = e.key,
      ...
      i = this.Es(e);
    return (
      (this.docs = this.docs.insert(n, { document: e.mutableCopy(), size: i })),
      (this.size += i - r),
  ...
  getEntry(t, e) {
    ...
    return xr.resolve(n ? n.document.mutableCopy() : no.newInvalidDocument(e));
  }
  getEntries(t, e) {
    let n = ga();
    return (
  ...
  getDocumentsMatchingQuery(t, e, n, s) {
    ...
    for (; a.hasNext(); ) {
      ...
      t.path.length > i.length + 1 ||
        Er(Ir(o), n) <= 0 ||
        ((s.has(o.key) || xo(e, o)) && (r = r.insert(o.key, o.mutableCopy())));
    }
    return xr.resolve(r);
  }
  getAllFromCollectionGroup(t, e, n, s) {
...
class Th {
  ...
  allocateTargetId(t) {
    return (
      (this.highestTargetId = this.vs.next()), xr.resolve(this.highestTargetId)
    );
  }
  setTargetsMetadata(t, e, n) {
    return (
...
class Sh {
  ...
  getMutationQueue(t, e) {
    ...
    return (
      n || ((n = new Ih(e, this.referenceDelegate)), (this.Vs[t.toKey()] = n)),
      n
    );
  }
  getTargetCache() {
  ...
  Ms(t, e) {
    return xr.or(Object.values(this.Vs).map((n) => () => n.containsKey(t, e)));
  }
}
class _h extends Sr {
  constructor(t) {
...
class xh {
  ...
  addReference(t, e, n) {
    return (
      this.Fs.addReference(n, e), this.Ls.delete(n.toString()), xr.resolve()
    );
  }
  removeReference(t, e, n) {
    return (
      this.Fs.removeReference(n, e), this.Ls.add(n.toString()), xr.resolve()
    );
  }
  markPotentiallyOrphaned(t, e) {
  ...
  $(t, e, n, s) {
    ...
    return (
          ...
          (function (t) {
            const e = t.store("targetGlobal"),
              n = {
                ...
                lastRemoteSnapshotVersion: or.min().toTimestamp(),
                targetCount: 0,
              };
      ...
      n < 12 &&
        ...
        (i = i.next(() => {
          !(function (t) {
            const e = t.createObjectStore("documentOverlays", { keyPath: Lu });
            e.createIndex("collectionPathOverlayIndex", Mu, { unique: !1 }),
              e.createIndex("collectionGroupOverlayIndex", Fu, { unique: !1 });
          })(t);
        })),
      n < 13 &&
        s >= 13 &&
        ...
        (i = i.next(() =>
          (function (t) {
            t
              ...
              t
                .createObjectStore("indexState", { keyPath: Cu })
                .createIndex("sequenceNumberIndex", Nu, { unique: !1 }),
              t
                .createObjectStore("indexEntries", { keyPath: ku })
                .createIndex("documentKeyIndex", Ru, { unique: !1 });
          })(t)
        )),
      i
    );
  ...
  zs(t, e) {
    ...
    return n.W().next((t) => {
      ...
      return (
        t.forEach((t) => {
          var e;
          let s = null !== (e = n.get(t.userId)) && void 0 !== e ? e : Sa();
          Ju(this.yt, t)
            .keys()
            .forEach((t) => (s = s.add(t))),
            n.set(t.userId, s);
        ...
        xr.forEach(n, (t, n) => {
          ...
          return new gh(s, u, o, a)
            .recalculateAndSaveOverlaysForDocumentKeys(new Uu(e, Pr.at), t)
            .next();
        })
      );
    });
...
class Nh {
  ...
  ui() {
    return this.runTransaction(
      ...
      .catch((t) => {
        if (kr(t))
          return (
            Ms("IndexedDbPersistence", "Failed to extend owner lease: ", t),
            this.isPrimary
          );
      ...
      .then((t) => {
        this.isPrimary !== t && this.Hs.enqueueRetryable(() => this.si(t)),
          (this.isPrimary = t);
      });
  }
  fi(t) {
      ...
      const t = await this.runTransaction(
        ...
        (t) => {
          ...
          return e.W().next((t) => {
            ...
            return xr.forEach(s, (t) => e.delete(t.clientId)).next(() => s);
          });
        }
      ).catch(() => []);
  ...
  hi() {
    this.ei = this.Hs.enqueueAfterDelay("client_metadata_refresh", 4e3, () =>
      this.ui()
        .then(() => this.yi())
        .then(() => this.hi())
    );
  ...
  pi(t, e) {
    ...
    return !(
      t < n - e ||
      (t > n &&
        (Fs(`Detected an update time that is in the future: ${t} > ${n}`), 1))
    );
  }
  ci() {
    null !== this.document &&
  ...
  bi() {
    this.Zs &&
      (this.window.removeEventListener("pagehide", this.Zs), (this.Zs = null));
  }
  Ei(t) {
    var e;
    try {
      ...
      return (
        Fs("IndexedDbPersistence", "Failed to get zombied client id.", t), !1
      );
    }
  }
  Ai() {
...
class Fh {
  ...
  ki(t, e) {
    ...
    return this.indexManager.getIndexType(t, n).next((s) =>
      0 === s
        ? null
        : (null !== e.limit && 1 === s && ((e = Eo(e, null, "F")), (n = Io(e))),
          this.indexManager.getDocumentsMatchingTarget(t, n).next((s) => {
            const r = Sa(...s);
  ...
  return await n.persistence.runTransaction(
    ...
    (t) => {
      ...
      return n.mutationQueue
        .getAllMutationBatches(t)
        .next(
          (r) => ((s = r), n.Qi(e), n.mutationQueue.getAllMutationBatches(t))
        )
        .next((e) => {
          const r = [],
            i = [];
          ...
          return n.localDocuments
            .getDocuments(t, o)
            .next((t) => ({ ji: t, removedBatchIds: r, addedBatchIds: i }));
        });
    }
  );
}
  ...
  return (
    ...
    e.getEntries(t, s).next((t) => {
      ...
      return (
        n.forEach((n, i) => {
          const o = t.get(n);
          i.isFoundDocument() !== o.isFoundDocument() && (r = r.add(n)),
    ...
    .then((t) => {
      ...
      return (
        (null === s || t.snapshotVersion.compareTo(s.snapshotVersion) > 0) &&
          ((n.qi = n.qi.insert(t.targetId, t)), n.Ui.set(e, t.targetId)),
        t
      );
    });
}
async function Kh(t, e, n) {
  ...
  try {
    ...
    if (!kr(t)) throw t;
    Ms("LocalStore", `Failed to update sequence numbers for target ${e}: ${t}`);
  }
...
function jh(t, e, n) {
  ...
  return s.persistence.runTransaction("Execute query", "readonly", (t) =>
    (function (t, e, n) {
      const s = Us(t),
        r = s.Ui.get(n);
      return void 0 !== r ? xr.resolve(s.qi.get(r)) : s.Cs.getTargetData(e, n);
    })(s, t, Io(e))
      .next((e) => {
        if (e)
          return (
            (r = e.lastLimboFreeSnapshotVersion),
            s.Cs.getMatchingKeysForTargetId(t, e.targetId).next((t) => {
              i = t;
            })
          );
      })
      .next(() =>
        s.Li.getDocumentsMatchingQuery(t, e, n ? r : or.min(), n ? i : Sa())
      )
...
function Qh(t, e) {
  ...
  return n.persistence
    .runTransaction("Get new document changes", "readonly", (t) =>
      n.Gi.getAllFromCollectionGroup(t, e, vr(s, -1), Number.MAX_SAFE_INTEGER)
    )
    .then((t) => (zh(n, e, t), t));
}
function zh(t, e, n) {
...
async function Hh(t, e, n = Sa()) {
  ...
  return r.persistence.runTransaction("Save named query", "readwrite", (t) => {
    ...
    if (s.snapshotVersion.compareTo(i) >= 0) return r.Ns.saveNamedQuery(t, e);
    const o = s.withResumeToken(Hr.EMPTY_BYTE_STRING, i);
    return (
      (r.qi = r.qi.insert(o.targetId, o)),
      r.Cs.updateTargetData(t, o)
        .next(() => r.Cs.removeMatchingKeysForTargetId(t, s.targetId))
...
class el {
  ...
  static Zi(t) {
    ...
    return "object" == typeof e &&
      ...
      : (Fs("SharedClientState", `Failed to parse online state: ${t}`), null);
  }
}
class nl {
  constructor() {
...
class sl {
  ...
  rr(t) {
    ...
    if (e.storageArea === this.storage) {
      if (
        (Ms("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.ar)
      )
        return void Fs(
...
class cl extends class {
          ...
          try {
            switch (o.getLastErrorCode()) {
              case Is.NO_ERROR:
                ...
                Ms("Connection", "XHR received:", JSON.stringify(e)), r(e);
                break;
              case Is.TIMEOUT:
                Ms("Connection", 'RPC "' + t + '" timed out'),
                  i(new Ks(Gs.DEADLINE_EXCEEDED, "Request time out"));
                break;
              case Is.HTTP_ERROR:
                const n = o.getStatus();
                if (
                ...
                } else i(new Ks(Gs.UNAVAILABLE, "Connection failed."));
                break;
              default:
                Ps();
            }
  ...
  wo(t, e, n) {
    ...
    const l = new ul({
        Hr: (t) => {
          h
            ? Ms("Connection", "Not sending because WebChannel is closed:", t)
            : (c ||
                (Ms("Connection", "Opening WebChannel transport."),
                u.open(),
                (c = !0)),
    ...
    return (
      ...
      d(u, xs.EventType.CLOSE, () => {
        h ||
          ((h = !0), Ms("Connection", "WebChannel transport closed"), l.io());
      }),
      d(u, xs.EventType.ERROR, (t) => {
        h ||
          ((h = !0),
          Os("Connection", "WebChannel transport errored:", t),
          l.io(new Ks(Gs.UNAVAILABLE, "The operation could not be completed")));
      }),
        ...
        if (!h) {
          ...
          if (r) {
            ...
            void 0 === e &&
              ((e = Gs.INTERNAL),
              (n =
                "Unknown error status: " + t + " with message " + r.message)),
              (h = !0),
              l.io(new Ks(e, n)),
              u.close();
      ...
      d(i, Es.STAT_EVENT, (t) => {
        t.stat === Ts
          ...
          : t.stat === Ss && Ms("Connection", "Detected no buffering proxy");
      }),
      setTimeout(() => {
        l.so();
      }, 0),
        ...
        if ("targetChange" in e) {
          ...
          const s = (function (t) {
            ...
            a =
              o &&
              (function (t) {
                const e = void 0 === t.code ? Gs.UNKNOWN : da(t.code);
          ...
          const r = za(t, s.document.name),
            ...
            o = s.document.createTime ? Ka(s.document.createTime) : or.min(),
...
class pl extends ml {
  ...
  onMessage(t) {
    if (
      (qs(!!t.streamToken), (this.lastStreamToken = t.streamToken), this.Jo)
    ) {
      this.xo.reset();
      const e = (function (t, e) {
          return t && t.length > 0
            ? (qs(void 0 !== e),
              t.map((t) =>
                (function (t, e) {
                  let n = t.updateTime ? Ka(t.updateTime) : Ka(e);
                  return (
...
async function Rl(t, e, n) {
  if ((t.gu.set("Online"), e instanceof ka && 2 === e.state && e.cause))
    ...
    (e instanceof Ca ? t.yu.Kt(e) : e instanceof Na ? t.yu.Jt(e) : t.yu.jt(e),
    !n.isEqual(or.min()))
  )
    try {
        ...
        (await (function (t, e) {
          ...
          return (
            ...
            n.targetMismatches.forEach((e) => {
              ...
              t.du.set(
                e,
                n.withResumeToken(Hr.EMPTY_BYTE_STRING, n.snapshotVersion)
              ),
                _l(t, e);
  ...
  e &&
    ...
    (await (async function (t, e) {
      if (la((n = e.code)) && n !== Gs.ABORTED) {
        const n = t.fu.shift();
        zl(t).Mo(),
          await Ml(t, () => t.remoteSyncer.rejectFailedWrite(n.batchId, e)),
          await Fl(t);
      }
      var n;
    })(t, e)),
  ...
  cancel(t) {
    null !== this.timerHandle &&
      ...
      this.deferred.reject(
        new Ks(Gs.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))
      ));
  }
  handleDelayElapsed() {
...
class cd {
  ...
  Fu(t) {
    ...
    if (t.ku.namedQuery) this.queries.push(t.ku.namedQuery);
      ...
      t.ku.document &&
        ((this.documents[this.documents.length - 1].document = t.ku.document),
        ++e);
  ...
  async complete() {
    const t = await (async function (t, e, n, s) {
        ...
        const a = r.Gi.newChangeBuffer({ trackRemovals: !0 }),
          u = await Gh(
            r,
            (function (t) {
              return Io(mo(ur.fromString(`__bundle__/docs/${t}`)));
            })(s)
          );
            ...
            Bh(t, a, o)
              ...
              .next((e) =>
                r.Cs.removeMatchingKeysForTargetId(t, u.targetId)
                  ...
                  .next(() =>
                    r.localDocuments.getLocalViewOfDocuments(t, e.Wi, e.zi)
                  )
                  .next(() => e.Wi)
              )
        );
    ...
    for (const t of this.queries) await Hh(this.localStore, t, e.get(t.name));
    return (
...
class fd {
        ...
        c && h
          ? c.data.isEqual(h.data)
            ...
            : this.Hu(c, h) ||
              ...
              (f = !0),
              ((a && this.Gu(h, a) > 0) || (u && this.Gu(h, u) < 0)) &&
                (o = !0))
          : !c && h
          ? (n.track({ type: 0, doc: h }), (f = !0))
          : c &&
            !h &&
            (n.track({ type: 1, doc: c }), (f = !0), (a || u) && (o = !0)),
          f &&
            (h
  ...
  bu(t) {
    return this.current && "Offline" === t
      ? ((this.current = !1),
        this.applyChanges(
          { Qu: this.Qu, zu: new Xl(), mutatedKeys: this.mutatedKeys, $i: !1 },
          !1
        ))
      : { Xu: [] };
  }
  Zu(t) {
    return (
      !this.qu.has(t) && !!this.Qu.has(t) && !this.Qu.get(t).hasLocalMutations
    );
  }
  Ju(t) {
    t &&
...
async function yd(t, e) {
  ...
  if (i)
    ...
    (s = t.targetId), (r = await wd(n, e, s, "current" === i, t.resumeToken));
  }
  return r;
}
async function wd(t, e, n, s, r) {
  t._c = (e, n, s) =>
    (async function (t, e, n, s) {
      let r = e.view.Wu(n);
      r.$i &&
        (r = await jh(t.localStore, e.query, !1).then(({ documents: t }) =>
          e.view.Wu(t, r)
        ));
      ...
      return n.persistence
        .runTransaction("Apply remote event", "readwrite-primary", (t) => {
          ...
          e.targetChanges.forEach((i, a) => {
            ...
            if (!u) return;
            o.push(
              n.Cs.removeMatchingKeys(t, i.removedDocuments, a).next(() =>
            ...
            e.targetMismatches.has(a)
              ? (c = c
                  .withResumeToken(Hr.EMPTY_BYTE_STRING, or.min())
                  .withLastLimboFreeSnapshotVersion(or.min()))
          ...
          if (
            (e.documentUpdates.forEach((s) => {
              e.resolvedLimboDocuments.has(s) &&
                o.push(
                  n.persistence.referenceDelegate.updateLimboDocument(t, s)
                );
            }),
            o.push(
            ...
            const e = n.Cs.getLastRemoteSnapshotVersion(t).next((e) =>
              n.Cs.setTargetsMetadata(t, t.currentSequenceNumber, s)
            );
            o.push(e);
          }
          return xr
            .waitFor(o)
            .next(() => i.apply(t))
            .next(() => n.localDocuments.getLocalViewOfDocuments(t, a, u))
            .next(() => a);
        })
        .then((t) => ((n.qi = r), t));
    })(n.localStore, e);
      ...
      return n.persistence.runTransaction(
        ...
        (t) => {
          ...
          return n.mutationQueue
            ...
            .next(() =>
              n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t, s)
            )
            .next(() => n.localDocuments.getDocuments(t, s));
        }
      );
      ...
      return n.persistence.runTransaction(
        ...
        (t) =>
          s
            .Tn(t, e)
            .next((e) =>
              e ? n.localDocuments.getDocuments(t, e) : xr.resolve(null)
            )
      );
    })(r.localStore, e);
  null !== i
...
async function Pd(t, e, n) {
  ...
  for (const t of e) {
    ...
    if (n && 0 !== n.length) {
      ...
      (e = await Gh(s.localStore, n)), await wd(s, qd(n), t, !1, e.resumeToken);
    }
    r.push(e);
  }
  return s.sc.Wo(i), r;
...
async function Gd(t, e, n) {
  ...
  if (s.dc) {
    for (const t of e) {
      ...
      await wd(s, qd(e), n.targetId, !1, n.resumeToken), El(s.remoteStore, n);
    }
    for (const t of n)
      s.rc.has(t) &&
          ...
          if ((Kd(n), jd(n), !0 === e && !0 !== n.dc)) {
            ...
            n.rc.forEach((s, r) => {
              n.sharedClientState.isLocalQueryTarget(r)
                ? t.push(r)
                : (e = e.then(() => (Dd(n, r), Kh(n.localStore, r, !0)))),
                Tl(n.remoteStore, r);
            }),
              await e,
              await Pd(n, t),
...
function Yd(t, e, n, s) {
  if (!0 === e && !0 === s)
    throw new Ks(Gs.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
}
function Xd(t) {
  ...
  if (
    ...
    if ("string" == typeof s.mockUserToken)
      ...
      e = (function (t, e) {
        ...
        s.mockUserToken,
        null === (r = t._app) || void 0 === r ? void 0 : r.options.projectId
      );
...
class yf {
  ...
  async Sc() {
    ...
    const t = this.xc();
    t < 0 &&
      this.Dc("Reached the end of bundle when a length string is expected.");
...
class bf {
          ...
          return "found" in e
            ? (function (t, e) {
                ...
                const n = za(t, e.found.name),
                  ...
                  r = e.found.createTime ? Ka(e.found.createTime) : or.min(),
                  i = new to({ mapValue: { fields: e.found.fields } });
  ...
  recordVersion(t) {
    ...
    if (n) {
      if (!e.isEqual(n))
        throw new Ks(Gs.ABORTED, "Document version changed between two reads.");
...
class Ef {
  ...
  Fc(t) {
    this.kc > 0 && this.$c(t)
      ? ((this.kc -= 1),
        this.asyncQueue.enqueueAndForget(() => (this.Oc(), Promise.resolve())))
    ...
    t.asyncQueue.enqueueAndForget(async () =>
      (function (t, e, n, s, r) {
        const i = new pf({
          ...
          o = new od(mo(n.path), i, { includeMetadataChanges: !0, Nu: !0 });
        return ed(t, o);
    ...
    return (
      ...
      (function (t, e) {
        ...
        (function (t, e) {
          ...
          if (t instanceof ArrayBuffer) return gf(new Uint8Array(t), e);
  ...
  constructor() {
    (this.Bc = Promise.resolve()),
      ...
      (this.Wc = () => {
        const t = ll();
        t &&
          Ms("AsyncQueue", "Visibility state changed to " + t.visibilityState),
          this.xo.Po();
      });
    const t = ll();
    t &&
...
class Uf extends rf {
  constructor(t, e, n, s) {
    super(t, e, n, s),
      (this.type = "firestore"),
      (this._queue = new Vf()),
      (this._persistenceKey = (null == s ? void 0 : s.name) || "[DEFAULT]");
  }
  _terminate() {
    return this._firestoreClient || $f(this), this._firestoreClient.terminate();
  }
}
function Gf(t, e, s) {
  s || (s = "(default)");
        ...
        if (
          !(function (t) {
            return "FirebaseError" === t.name
              ? t.code === Gs.FAILED_PRECONDITION || t.code === Gs.UNIMPLEMENTED
              : !(
          ...
          try {
            const t = await (function (t) {
              ...
              return e.persistence.runTransaction(
                ...
                "readonly",
                (t) => e.mutationQueue.getHighestUnacknowledgedBatchId(t)
              );
            })(n.localStore);
...
function em(t, e) {
  ...
  })(jf((t = tf(t, Uf))), e).then((e) => (e ? new uf(t, null, e.query) : null));
}
function nm(t) {
  if (t._initialized || t._terminated)
    throw new Ks(
...
class fm {
  ...
  da(t, e, n, s = !1) {
    return new dm(
      { sa: t, methodName: e, fa: n, path: hr.emptyPath(), oa: !1, la: s },
      this.databaseId,
      this.yt,
      this.ignoreUndefinedProperties
    );
...
function gm(t, e, n, s, r, i = {}) {
  ...
  if (i.merge) (u = new Zi(o.fieldMask)), (c = o.fieldTransforms);
    ...
    (u = new Zi(t)), (c = o.fieldTransforms.filter((t) => u.covers(t.field)));
...
function Cm(t, e, n) {
  ...
  throw Rm("Field path arguments must be of type string or ", t, !1, void 0, n);
}
const Nm = new RegExp("[~\\*/\\[\\]]");
function km(t, e, n) {
  if (e.search(Nm) >= 0)
...
class Um extends qm {
  ...
  _apply(t) {
    ...
    return og(t._query, e), new uf(t.firestore, t.converter, bo(t._query, e));
  }
  _parse(t) {
        ...
        ((this._cachedChanges = (function (t, e) {
          if (t._snapshot.oldDocs.isEmpty()) {
            ...
            return t._snapshot.docChanges.map((n) => {
              ...
              return (
                n.doc, { type: "added", doc: s, oldIndex: -1, newIndex: e++ }
              );
            });
          }
          {
            ...
            return t._snapshot.docChanges
              ...
              .map((e) => {
                ...
                return (
                  0 !== e.type &&
                    ((r = n.indexOf(e.doc.key)), (n = n.delete(e.doc.key))),
                  1 !== e.type &&
                    ((n = n.add(e.doc)), (i = n.indexOf(e.doc.key))),
                  { type: pg(e.type), doc: s, oldIndex: r, newIndex: i }
                );
              });
          }
        })(this, e)),
      ...
      t.asyncQueue.enqueueAndForget(async () =>
        (async function (t, e, n) {
          try {
            ...
            const s = Wl(t, `Failed to get document '${e} from cache`);
            n.reject(s);
          }
        })(await Cf(t), e, n)
      ),
      ...
      t.asyncQueue.enqueueAndForget(async () =>
        (async function (t, e, n) {
          try {
            ...
            const s = Wl(t, `Failed to execute query '${e} against cache`);
            n.reject(s);
          }
        })(await Cf(t), e, n)
      ),
...
function Sg(t) {
  ...
  const e = tf(t.firestore, Uf),
    n = jf(e),
    s = new vg(e);
  return Ff(n, t._query, { source: "server" }).then((n) => new gg(e, s, t, n));
}
function _g(t, e, n) {
  t = tf(t, af);
...
function Cg(t, ...e) {
  ...
  return (function (t, e, n, s) {
    ...
    return (
      ...
      () => {
        r.bc(), t.asyncQueue.enqueueAndForget(async () => nd(await Lf(t), i));
      }
    );
  })(jf(c), h, a, u);
}
          ...
          try {
            const t = await (function (t, e) {
              ...
              return n.persistence
                .runTransaction("Locally write mutations", "readwrite", (t) => {
                  ...
                  return n.Gi.getEntries(t, r)
                    ...
                    .next((r) => {
                      ...
                      const o = [];
                      for (const t of e) {
                        const e = Zo(t, i.get(t.key).overlayedDocument);
                        null != e &&
                          o.push(
                            new na(
                              t.key,
                ...
                .then(() => ({ batchId: o.batchId, changes: wa(i) }));
            })(s.localStore, e);
...
class Og {
  ...
  delete(t) {
    ...
    return (
      (this._mutations = this._mutations.concat(new oa(e._key, zo.none()))),
      this
    );
  }
  commit() {
...
class Pg extends class {
  constructor(t, e) {
    (this._firestore = t), (this._transaction = e), (this._dataReader = mm(t));
  }
  get(t) {
    const e = Vg(t, this._firestore),
  ...
  update(t, e, n, ...s) {
    ...
    return (
      (i =
        "string" == typeof (e = I(e)) || e instanceof rm
          ? Tm(this._dataReader, "Transaction.update", r._key, e, n, s)
...
function qg(t, e, n) {
  ...
  return (
    (function (t) {
      if (t.maxAttempts < 1)
        throw new Ks(Gs.INVALID_ARGUMENT, "Max attempts must be at least 1");
    })(s),
    (function (t, e, n) {
      const s = new js();
      return (
        ...
        "string" == typeof t
          ? (function (t) {
              try {
                ...
                throw new Ks(
                  Gs.INVALID_ARGUMENT,
                  "Failed to parse JSON: " + (null == t ? void 0 : t.message)
                );
              }
            })(t)
          : t,
      ...
      for (const t of e.indexes) {
        ...
        if (Array.isArray(t.fields))
          for (const e of t.fields) {
            const t = km("setIndexConfiguration", zg(e, "fieldPath"));
    ...
    t(
      new b(
        ...
        (t, { instanceIdentifier: e, options: n }) => {
          ...
          return (
            (n = Object.assign({ useFetchStreams: s }, n)), i._setSettings(n), i
          );
        },
        "PUBLIC"
